...
A friend request is sent by making a POST request to /friend/<username>
A friend request is confirmed by making a PUT request to /friend/<username>
A user's list of friendships can be seen by making a GET request to /friend/<username>
